...
alloc_proc(void) {
     ...
     */
     //LAB5 2016011446 : (update LAB4 steps)
    /*
   ...
   */
     ...
     */
    //LAB8:EXERCISE2 2016011446 HINT:need add some code to init fs in proc_struct, ...
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    //LAB8:EXERCISE2 2016011446  HINT:how to copy the fs in parent's proc_struct?
    /*
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2016011446  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
    ...
    // struct proghdr *ph = (struct proghdr *)(elf_p + elf.e_phoff);
